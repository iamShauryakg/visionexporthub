  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md overflow-y-auto">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-50 w-9 h-9 bg-black border border-zinc-800 text-zinc-400 hover:text-white hover:border-amber-500 transition-all flex items-center justify-center cursor-pointer"
        ...
        <div className="w-full md:w-80 bg-[#070709] border-b md:border-b-0 md:border-r border-zinc-900 p-6 flex flex-col justify-between relative z-10 space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-3 border transition-all rounded-none cursor-pointer flex flex-col ${
                      isSelected 
                        ...
                        : "bg-zinc-950/60 border-zinc-900 text-zinc-400 hover:text-white hover:border-zinc-850"
                    }`}
                  >
                    <div className="flex items-center space-x-2">
                      <Icon className={`w-4 h-4 flex-shrink-0 ${isSelected ? "text-amber-500" : "text-zinc-500"}`} />
                      <span className="text-xs font-sans font-bold tracking-wide">
                        {tab.label}
                      </span>
                    </div>
                    <span className="text-[9px] block mt-1 leading-snug font-sans font-medium text-zinc-500 lowercase first-letter:uppercase">
                      {tab.subtitle}
                    </span>
                  </button>
                );
          ...
          <div className="bg-zinc-950 border border-zinc-900 p-4 space-y-3">
            ...
            <div className="space-y-2 text-[10px] font-mono text-zinc-400 leading-normal uppercase">
        ...
        <div className="flex-1 flex flex-col justify-between overflow-y-auto h-[60vh] md:h-[80vh] p-8 relative z-10 bg-black/40 legal-page legal-content-area">
          ...
          <div className="space-y-6">
            ...
            <div>
              {activeTab === "privacy" && (
                <div className="space-y-1">
                  <h2 className="font-sans text-xl sm:text-2xl font-bold text-white tracking-wide">
              ...
              <div className="w-12 h-[3px] bg-amber-500 mt-3"></div>
            </div>
            ...
            <div className="font-sans text-sm text-zinc-300 leading-relaxed space-y-6">
              ...
              {activeTab === "privacy" && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                    <div className="bg-[#08080a] border border-zinc-900 p-4.5 rounded-none space-y-2">
                      <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-500 mb-2">
                        <ShieldCheck className="w-4 h-4" />
                      </div>
                      <h4 className="text-xs font-bold text-white uppercase">1. Biological Traceability</h4>
                      ...
                      <span className="text-[8px] font-mono text-emerald-500 uppercase tracking-widest block pt-1">// 100% ETHICALLY HARVESTED</span>
                    </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4.5 rounded-none space-y-2">
                      ...
                      <h4 className="text-xs font-bold text-white uppercase">2. Client CAD & NDA Protection</h4>
                      <p className="text-[10px] text-zinc-400 leading-normal">
                      ...
                      <span className="text-[8px] font-mono text-amber-500 uppercase tracking-widest block pt-1">// COMPREHENSIVE NDAS SIGNED</span>
                    </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4.5 rounded-none space-y-2">
                      ...
                      <h4 className="text-xs font-bold text-white uppercase">3. Secure Communications</h4>
                      <p className="text-[10px] text-zinc-400 leading-normal">
                      ...
                      <span className="text-[8px] font-mono text-zinc-500 block pt-1">sales@visionexporthub.com</span>
                    </div>
                  </div>

                  <div className="p-4 bg-zinc-950 border border-zinc-900 rounded-none space-y-2">
                    <span className="text-[9px] font-mono font-bold uppercase text-amber-500 tracking-wider">Corporate Commitment</span>
              ...
              {activeTab === "moq" && (
                <>
                  ...
                  <div className="overflow-x-auto border border-zinc-900 bg-[#070709] my-4">
                    <table className="w-full text-left text-xs text-zinc-300">
                      <thead className="bg-[#0c0c10] text-[9px] uppercase tracking-wider font-mono text-zinc-400 border-b border-zinc-900">
                        <tr>
                      ...
                      <tbody className="divide-y divide-zinc-900">
                        <tr className="hover:bg-zinc-900/40">
                          <td className="p-3 font-semibold text-white">Horn Button Blanks</td>
                          <td className="p-3 text-right text-amber-500 font-bold">5,000 Pcs</td>
                          <td className="p-3 text-zinc-400 text-xs">Free with run (Per size & thickness)</td>
                          <td className="p-3 text-zinc-400 text-xs">15 - 20 Business Days</td>
                        </tr>
                        <tr className="hover:bg-zinc-900/40">
                          <td className="p-3 font-semibold text-white">Bone Buttons & Blanks</td>
                          <td className="p-3 text-right text-amber-500 font-bold">3,000 Pcs</td>
                          <td className="p-3 text-zinc-400 text-xs">Free with run (Natural or bleached)</td>
                          <td className="p-3 text-zinc-400 text-xs">20 - 25 Business Days</td>
                        </tr>
                        <tr className="hover:bg-zinc-900/40">
                          <td className="p-3 font-semibold text-white">Premium Horn Plates</td>
                          <td className="p-3 text-right text-amber-500 font-bold">250 Pcs</td>
                          <td className="p-3 text-zinc-400 text-xs">Custom flat stock thickness leveling</td>
                          <td className="p-3 text-zinc-400 text-xs">10 - 15 Business Days</td>
                        </tr>
                        <tr className="hover:bg-zinc-900/40">
                          <td className="p-3 font-semibold text-white">Natural Raw Horn Tips</td>
                          <td className="p-3 text-right text-amber-500 font-bold">100 Kilograms</td>
                          <td className="p-3 text-zinc-400 text-xs">By-weight lot assortment</td>
                          <td className="p-3 text-zinc-400 text-xs">7 - 10 Business Days</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>

                  <div className="bg-[#08080a] border border-zinc-900 p-4.5 space-y-2.5">
                    <h5 className="text-xs font-bold text-white uppercase tracking-wider">Custom Prototyping & Sample Mockups</h5>
              ...
              {activeTab === "certificates" && (
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-[#08080a] border border-zinc-900 p-4 relative overflow-hidden group hover:border-amber-500/40 transition-colors">
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="p-2 bg-emerald-950/40 border border-emerald-500/25 text-emerald-500 rounded-none flex-shrink-0">
                          <Award className="w-5 h-5" />
                        </div>
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-white uppercase tracking-tight">1. Veterinary Sanitary Certificate</h4>
                          <p className="text-[10px] text-zinc-400 leading-normal">
                          ...
                          <div className="text-[8px] font-mono text-zinc-600 mt-2">DOC REF: IND-VET-MIN-2026</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 relative overflow-hidden group hover:border-amber-500/40 transition-colors">
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="p-2 bg-amber-950/40 border border-amber-500/25 text-amber-500 rounded-none flex-shrink-0">
                          <Scale className="w-5 h-5" />
                        </div>
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-white uppercase tracking-tight">2. CITES Exemption Declaration</h4>
                          <p className="text-[10px] text-zinc-400 leading-normal">
                          ...
                          <div className="text-[8px] font-mono text-zinc-600 mt-2">DOC REF: CITES-EXMPT-DOM</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 relative overflow-hidden group hover:border-amber-500/40 transition-colors">
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="p-2 bg-blue-950/40 border border-blue-500/25 text-blue-400 rounded-none flex-shrink-0">
                          <ShieldCheck className="w-5 h-5" />
                        </div>
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-white uppercase tracking-tight">3. REACH Directive Compliance</h4>
                          <p className="text-[10px] text-zinc-400 leading-normal">
                          ...
                          <div className="text-[8px] font-mono text-zinc-600 mt-2">DOC REF: REACH-EU-SAFETY</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 relative overflow-hidden group hover:border-amber-500/40 transition-colors">
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="p-2 bg-teal-950/40 border border-teal-500/25 text-teal-400 rounded-none flex-shrink-0">
                          <Truck className="w-5 h-5" />
                        </div>
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-white uppercase tracking-tight">4. Fumigation / Phytosanitary Certificate</h4>
                          <p className="text-[10px] text-zinc-400 leading-normal">
                            Ensures container-level methyl bromide or advanced heat treatment of pallets, preventing any transit pest vectors.
                          </p>
                          <div className="text-[8px] font-mono text-zinc-600 mt-2">DOC REF: FUM-PHYTO-LOT-X</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === "terms" && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4 font-sans">
                    <div className="bg-[#08080a] border border-zinc-900 p-4 space-y-3">
                      <span className="text-[10px] font-mono text-amber-500 uppercase block font-bold tracking-wider">// SETTLEMENT MILESTONES</span>
                      <div className="space-y-2 text-xs">
                        <div className="flex justify-between items-center border-b border-zinc-900 pb-2">
                          <span className="text-zinc-300 font-semibold">1. Advance Telegraphic Deposit:</span>
                          <span className="font-mono text-white bg-amber-500/15 border border-amber-500/30 px-2 py-0.5 font-bold">50% Deposit</span>
                        </div>
                        <div className="flex justify-between items-center pt-1">
                          <span className="text-zinc-300 font-semibold">2. Balance Upon Shipment Ready:</span>
                          <span className="font-mono text-white bg-zinc-800 border border-zinc-700 px-2 py-0.5 font-bold">50% Balance</span>
                        </div>
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 space-y-3">
                      <span className="text-[10px] font-mono text-amber-500 uppercase block font-bold tracking-wider">// SWIFT & WIRE CHANNELS</span>
                      ...
                      <div className="p-2 bg-black border border-zinc-900 flex items-center space-x-2 text-[9px] font-mono text-zinc-500 uppercase">
                  ...
                  <div className="p-4 bg-zinc-950 border border-zinc-900 rounded-none space-y-1.5 text-xs">
                    <h5 className="font-bold text-white uppercase tracking-wider">Currency & Pricing Volatility Protection</h5>
                    <p className="text-zinc-400 text-xs leading-normal">
              ...
              {activeTab === "freight" && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 font-sans">
                    <div className="bg-[#08080a] border border-zinc-900 p-4 space-y-2">
                      <div className="flex items-center space-x-2">
                        <MapPin className="w-4 h-4 text-amber-500" />
                        <h4 className="text-xs font-bold text-white uppercase">1. FOB Shipping Ports</h4>
                      </div>
                      <p className="text-[10px] text-zinc-400 leading-normal">
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <h4 className="text-xs font-bold text-white uppercase">2. Courier Networks</h4>
                      </div>
                      <p className="text-[10px] text-zinc-400 leading-normal">
                    ...
                    <div className="bg-[#08080a] border border-zinc-900 p-4 space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <h4 className="text-xs font-bold text-white uppercase">3. Custom Brokers</h4>
                      </div>
                      <p className="text-[10px] text-zinc-400 leading-normal">
                        While we manage veterinary sanity papers and Indian custom export clearances, clients designate their import brokers for duty clearances.
                      </p>
                    </div>
                  </div>

                  <div className="p-4 bg-zinc-950 border border-zinc-900 text-xs space-y-2.5">
                    <h5 className="font-bold text-white uppercase tracking-wider">Cargo Lead Times and Tracking</h5>
                    <p className="text-zinc-400 leading-normal">
                      Air transport packages are fully dispatched within 5-7 business days from custom verification, with direct airway tracking IDs sent via email. Sea cargo lots take 25-45 calendar days depending on target destination ports, managed under strict container load (LCL/FCL) guidelines.
                    </p>
                  </div>
                </>
              )}
          ...
          <div className="mt-8 pt-6 border-t border-zinc-900 grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs font-sans">
            <div className="space-y-2">
              ...
              <div className="space-y-1.5 text-zinc-300">
                <div className="flex items-center space-x-2">
                  ...
                  <a href="mailto:sales@visionexporthub.com" className="hover:text-amber-400 underline">
                    sales@visionexporthub.com
                  </a>
                </div>
                <div className="flex items-center space-x-2">
                  <Mail className="w-4 h-4 text-zinc-500" />
                  <a href="mailto:Rkshah231@gmail.com" className="hover:text-amber-400 underline">
                    Rkshah231@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5 text-zinc-300">
                <div className="flex items-center space-x-2">
                  ...
                  <a href="tel:+919548470907" className="hover:text-amber-400 underline">
                    +91 95484 70907 (Director Hotline)
                  </a>
                </div>
                <div className="flex items-center space-x-2">
                  <MessageSquare className="w-4 h-4 text-emerald-500" />
                  <a href="https://wa.me/919548470907" target="_blank" rel="noreferrer" className="hover:text-amber-400 underline">
                    WhatsApp Chat Desk
                  </a>
                </div>
              </div>
